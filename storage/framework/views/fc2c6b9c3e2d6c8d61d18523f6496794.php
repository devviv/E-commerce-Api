...
<?php endif; ?>
    <?php elseif($this->isTableLoaded() &&
             filled($this->defaultTableAction) &&
             filled($this->defaultTableActionRecord)): ?>
        <div
            wire:init="mountTableAction(<?php echo \Illuminate\Support\Js::from($this->defaultTableAction)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($this->defaultTableActionRecord)->toHtml() ?>)"
        ></div>
    <?php endif; ?> <!--[if ENDBLOCK]><![endif]-->
...
<?php /**PATH D:\MyworkSpace\Laravel\e-commerce\vendor\filament\filament\src\/../resources/views/components/page/index.blade.php ENDPATH**/ ?>